            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                ...
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <span class="hidden-xs"> Asha</span>
                </a>
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li><a href="<?= base_url();?>index.php/demo/search"><i class="fa fa-home"></i><span>Search</span></a></li>
            <li><a href="<?= base_url();?>index.php/demo"><i class="fa fa-home"></i><span>Home</span></a></li>
